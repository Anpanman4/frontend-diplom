  ...
  return (
    <section className="politic">
      <BreadCrumbs
        items={[
          { label: 'Главная', link: '/' },
          { label: 'Политика конфиденциальности', link: '/politic' }
        ]}
      />
      <Title className="politic__title" level={1}>
      ...
      <Text level={4} color="gray-1">
        ...
        безопасности персональных данных, предпринимаемые Титаренко Ярославом
        (далее — Оператор).
        <br />
        ...
        сети интернет по сетевому адресу https://thismywebsite.com.
        <br />
        ...
        <br />
        &bull; фамилия, имя, отчество
        <br />
        &bull; электронный адрес
        <br />
        &bull; номера телефонов
        <br />
        Правовые основания
        <br />
        &bull; уставные (учредительные) документы Оператора
        <br />
        Виды обработки персональных данных
        <br />
        &bull; Сбор, запись, систематизация, накопление, хранение, уничтожение и
        обезличивание персональных данных
        <br />
        &bull; Отправка информационных писем на адрес электронной почты
        <br />
        ...
        электронный адрес Оператора privacy@thismywebsite.com с пометкой «Отзыв
        ...
        Интернет по адресу https://thismywebsite.com/privacy/.
      </Text>
    </section>
  );
};
